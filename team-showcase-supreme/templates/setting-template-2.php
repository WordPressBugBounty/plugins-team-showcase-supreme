      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="top_text_bg_img" id="top-text-bg-img" class="wpm-form-input" value="<?php echo esc_attr($cssData['top_text_bg_img']); ?>" />
              <input type="button" id="top-text-bg-img-btn" value="Upload Image" class="wpm-btn-default">
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="top_text_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['top_text_bg_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          <tr>
            ...
            <td>
              <input type="text" name="social_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['social_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="social_hover_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['social_hover_color']); ?>">
            </td>
          </tr>
        </table>
      </div>
      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="technical_skill" class="wpm-form-input" value="<?php echo wpm_6310_replace($cssData['technical_skill']) ?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="technical_skill_font_size_desktop" class="wpm-form-input" value="<?php echo ($cssData['technical_skill_font_size_desktop']) ?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="technical_skill_font_size_mobile" class="wpm-form-input" value="<?php echo ($cssData['technical_skill_font_size_mobile']) ?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="technical_skill_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['technical_skill_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="contact_info" class="wpm-form-input" value="<?php echo wpm_6310_replace($cssData['contact_info']) ?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="contact_info_font_size_desktop" class="wpm-form-input" value="<?php echo ($cssData['contact_info_font_size_desktop']) ?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="contact_info_font_size_mobile" class="wpm-form-input" value="<?php echo ($cssData['contact_info_font_size_mobile']) ?>" />
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="contact_info_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['contact_info_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
