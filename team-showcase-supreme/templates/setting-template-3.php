      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          <tr>
            ...
            <td>
              <input type="text" name="top_text_left_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo ($cssData['top_text_left_bg_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
              <input type="text" name="top_text_right_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo esc_attr($cssData['top_text_right_bg_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
      ...
      <div class="wpm-col-6">
        <table class="table table-responsive wpm_6310_admin_table">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="contact_info_bg_color" class="wpm-form-input wpm_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['contact_info_bg_color']); ?>">
            </td>
          </tr>
          <tr>
            <td>
